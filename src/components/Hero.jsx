...
const Hero = () => {
  return (
    <section
  id="home"
  className="min-h-screen flex items-center justify-center px-4 sm:px-6 md:px-24 py-20 sm:py-24 bg-[#f9fafb]"
>
  <motion.div
  ...
  >
    <motion.h1
      ...
      className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-snug sm:leading-tight text-gray-900 font-heading mb-8"
    >
    ...
    <motion.p
      variants={itemVariantsUp}
      className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed tracking-wide font-medium mb-12 px-2 sm:px-0"
    >
