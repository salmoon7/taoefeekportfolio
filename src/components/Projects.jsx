...
const projects = [
  {
    ...
    live: "https://giraapp.live",
    github: "https://github.com/yourusername/gira-app",
  },
  {
    name: "Naturex",
    description: "E-commerce platform for natural products.",
    live: "https://naturex.live",
    github: "https://github.com/yourusername/naturex",
  },
  {
    name: "Zylo Converta",
    description: "Real-time file and media conversion web app.",
    live: "https://zyloconverta.com",
    github: "https://github.com/yourusername/zylo-converta",
  },
  {
    name: "FlashCard Web",
    description: "Interactive flashcard website to aid learning.",
    live: "https://flashcardweb.netlify.app",
    github: "https://github.com/yourusername/flashcard-web",
  },
  {
    name: "Crest Video Conferencing",
    description: "Secure video conferencing app with real-time chat.",
    live: "https://crestmeet.live",
    github: "https://github.com/yourusername/crest-meet",
  },
  {
    name: "Adamsfoam",
    description: "Corporate website for a foam manufacturing company.",
    live: "https://adamsfoam.ng",
    github: "https://github.com/yourusername/adamsfoam",
  },
  {
